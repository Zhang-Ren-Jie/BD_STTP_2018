...
FILE=$(wget "http://www.us.apache.org/dist/hive/stable-2/" -O - | grep -Po "apache-hive-[0-9].[0-9].[0-9]-bin.tar.gz" | head -n 1)
URL=http://www.us.apache.org/dist/hive/stable-2/$FILE
